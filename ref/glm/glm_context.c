/*
 * glm renderer - OpenGL 4.6 stub renderer
 * Based on null renderer architecture with OpenGL 4.6 configuration
 */
...
#define GLM_MINOR_VERSION 6
#define GLM_VERSION_STRING "OpenGL 4.6"
...
{
	gEngfuncs.Con_Printf( "GLM Renderer initialized (%s)\n", GLM_VERSION_STRING );
	gEngfuncs.Con_Printf( "GLM: This is a stub renderer - no actual OpenGL calls are made\n" );
	
	gEngfuncs.R_Init_Video( REF_GL );
	return true;
}
...
{
	return GLM_VERSION_STRING " (stub)";
}
...
{
    gEngfuncs.Con_Printf( "GLM: GL_RenderFrame called\n" );
}

static void R_RenderScene( void )
{
    gEngfuncs.Con_Printf( "GLM: R_RenderScene called\n" );
}
...
/*
 * Get extra parameters for texture
 */
